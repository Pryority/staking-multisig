...
contract MultiStake {
    ...
    // modifier notMajorityLST(address _protocol) {
    //     // Does a check of the protocol's balance (if possible) to see how whether or not it is a majority eth staker (we want decentralization!)
    //     require(!isMajority(protocol), "Tx already executed");
    //     _;
    // }
